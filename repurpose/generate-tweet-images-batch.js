...
const IG_HOOK_MAP = {
  ...
  'My community has the microcaps before X does':          'ig-2026-05-21-d2-community-first-microcap-rule-1l',
  'I never announced publicly until we were already up 50x': 'ig-2026-05-21-d3-lab-98x-kaspa-pattern-1l',
  'Two paths for $KAS by year-end':                        'ig-2026-05-20-kaspa-two-paths-2026-1l',
  'CoinMarketCap shows $BOBO at a $2.7B mcap':             'ig-2026-05-20-bobo-cmc-mess-1l',
  "I won't call new low-mcap coins on this channel":       'ig-2026-05-20-influencer-integrity-no-low-mcap-calls-1l',
  'My 2-signal meme filter: CEX listings held':            'ig-2026-05-20-meme-survival-filter-1l',
  'The goalpost is gone':                                  'ig-2026-05-21-e4-fedex-meat-neighbor-1l',
  'Real meme devs time their launches for rallies':        'ig-2026-05-21-c4-real-devs-time-launches-1l',
  'One day human driving will be illegal':                 'ig-2026-05-21-e3-self-driving-mandatory-1l',
  'New all-time highs come back onto the table if it passes': 'ig-2026-05-21-a4-clarity-act-ath-on-the-table-1l',
};
...
const IMAGES = [
  ...
  { hookSnippet: 'Real meme devs time their launches for rallies', uuid: 'rm05surf', slug: 'meme-devs-surf-rally', igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A cute chubby blue penguin character surfing confidently atop a massive glowing green rally wave at the perfect moment, while other meme-coin characters tumble and wipe out in the cold water below. Deep navy near-black background. Teal and green rim lighting. Well-timed triumphant mood. No text or words anywhere in the image.', refImage: null,
  ...
  { hookSnippet: 'The goalpost is gone', uuid: 'fx11robo', slug: 'delivery-robot-perfect', igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A precise glowing AI delivery robot character placing a package perfectly and gently on a doorstep under a clean bright spotlight, flawless and reliable. Deep navy near-black background. Cool blue rim lighting. Competent reassuring mood. No text or words anywhere in the image.', refImage: null,
  ...
  { hookSnippet: 'One day human driving will be illegal', uuid: 'dr12musm', slug: 'steering-wheel-museum', igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. An old-fashioned car steering wheel sealed inside a glowing museum glass display case on a pedestal, a relic of the past, a judge gavel resting beside it. Deep navy near-black background. Cool blue rim lighting. Solemn historic mood. No text or words anywhere in the image.', refImage: null,
  ...
  { hookSnippet: 'New all-time highs come back onto the table if it passes', uuid: 'cl13brk0', slug: 'coin-breaks-ath-ceiling', igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A determined coin character smashing upward through a glowing cracked ceiling into bright light above, green breakout energy trailing behind it. Deep navy near-black background. Green and gold rim lighting. Breakthrough triumphant mood. No text or words anywhere in the image.', refImage: null,
  ...
  { hookSnippet: '$PEPE has no brand, no IP, no revenue', uuid: 'pp15ldrb', slug: 'pengu-leaps-pepe-leaderboard', igPrompt: null, refImage: null,
  ...
  { hookSnippet: 'My community has the microcaps before X does', uuid: 'mc18circ', slug: 'community-inner-circle-bags', igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. An exclusive inner-circle table of cheering member characters holding glowing money bags, while a crowd of outsiders presses against a glass wall looking in from the dark. Deep navy near-black background. Teal and gold rim lighting. Insider-advantage mood. No text or words anywhere in the image.', refImage: null,
  ...
  { hookSnippet: 'Everyone was talking up HantaVirus', uuid: 'hv19tmbl', slug: 'hunter-virus-tumbleweed', igPrompt: null, refImage: null,
  ...
  { hookSnippet: 'I never announced publicly until we were already up 50x', uuid: 'lb20trph', slug: 'lab-98x-silent-trophy', igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. An investor character quietly holding up a glowing golden trophy in the shadows with one finger to the lips signaling silence, an understated private victory. Deep navy near-black background. Gold and teal rim lighting. Quiet-win mood. No text or words anywhere in the image.', refImage: null,
  ...
  { hookSnippet: 'manager has no direct reports; only AI', uuid: 'et21team', slug: 'engineering-teams-2-ai-only', igPrompt: null, refImage: null,
    xPrompt: 'Pixar-style 3D animated CGI illustration, 1:1 square, film-quality render. A large engineering team of ten characters shrinks down to just two while a fleet of glowing AI robot workers fills the gap behind them, one manager figure at the helm giving direction. Deep navy near-black background. Cool blue rim lighting. Transformed future-of-work mood. No text or words anywhere in the image.' },
  // IG-only companions — X files already exist; batch skips X gen and produces the 4:5 IG image.
  { hookSnippet: 'Two paths for $KAS by year-end', uuid: '44e7aba7', slug: 'institutions-choose-kas-infrastructure', refImage: null, xPrompt: null,
    igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A glowing Kaspa coin character standing at a crossroads under stormy and sunny skies, one bright upward path and one dark downward path, the macro environment looming overhead. Deep navy near-black background. Green and stormy blue rim lighting. Decisive fork-in-the-road mood. No text or words anywhere in the image.' },
  { hookSnippet: 'CoinMarketCap shows $BOBO at a $2.7B mcap', uuid: '7000f5ff', slug: 'bobo-magnifying-glass-fake-mcap', refImage: null, xPrompt: null,
    igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A wide-eyed coin character peering through a giant magnifying glass at a wildly inflated number on a glowing data screen, two orders of magnitude off reality. Deep navy near-black background. Skeptical blue rim lighting. Disbelieving discovery mood. No text or words anywhere in the image.' },
  { hookSnippet: "I won't call new low-mcap coins on this channel", uuid: 'cbfefe33', slug: 'influencer-integrity-no-low-mcap-shilling', refImage: null, xPrompt: null,
    igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A confident solo investor character holding a shield that blocks a swarm of hype-caller silhouettes trying to push low-mcap coins at them, standing firm. Deep navy near-black background. Clean white and gold rim lighting. Principled integrity mood. No text or words anywhere in the image.' },
  { hookSnippet: 'My 2-signal meme filter: CEX listings held', uuid: '3bf1a3c3', slug: 'meme-filter-two-signal-checklist', refImage: null, xPrompt: null,
    igPrompt: 'Pixar-style 3D animated CGI illustration, 4:5 portrait, film-quality render. A meticulous analyst character carefully checking off glowing green checkmarks on a two-item criteria board: CEX listings held and devs still posting through the worst days. Deep navy near-black background. Green and blue rim lighting. Methodical filter mood. No text or words anywhere in the image.' },
];
...
async function main() {
  console.log(`\n${'━'.repeat(60)}`);
  console.log(`Batch: ${IMAGES.length} entries (7 X to generate + 10 IG to generate, rest skipped)`);
