// render-containers.js — screenshot each standalone container (#c01..#cNN) from
// deck/containers.html to render-assets/container-NN.png at 1920x1080 @2x (3840x2160).
// Reuses the Playwright install from schedule-tweets/node_modules (same pattern as need-lang-graph).
...
(async () => {
  ...
  await page.evaluate(() => document.fonts.ready); // Playfair/JetBrains/DM Sans, not a fallback
