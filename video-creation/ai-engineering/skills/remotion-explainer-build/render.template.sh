...
# ── per-video ────────────────────────────────────────────────────────────────
COMP_ID="CHANGEME"                                   # Root.tsx composition id
PROJECT_DIR="C:/Users/mnede/Documents/Claude/social-media/video-creation/ai-engineering/media/CHANGEME"
DURATION_FRAMES=0                                    # = <PREFIX>_DURATION_FRAMES from the timeline module
