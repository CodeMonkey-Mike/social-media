"""cut_topics_newbottom.py - Phase 4 multi-snippet cutter for batch 'new-bottom'.
Reads shorts/new-bottom/clip-plan.json, cuts each clip's segments from the VERTICAL master
...
BATCH = "new-bottom"
MASTER = f"{VC}/livestream-repurpose/media/new bottom/new bottom LOW BPS VERTICAL.mp4"
