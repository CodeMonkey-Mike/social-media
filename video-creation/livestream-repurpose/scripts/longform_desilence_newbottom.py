"""Fast single-pass silence removal for the 'new bottom' longform (built for 26+ min).
silencedetect -> keep intervals -> ONE ffmpeg NVENC pass via the concat demuxer, dropping the
gaps. Outputs ~0.7 Mbps directly to the staged location. Modeled on longform_desilence_whatif.py.
"""
import subprocess, re, os, sys

SRC = r"C:\Users\mnede\Documents\Claude\social-media\video-creation\livestream-repurpose\media\new bottom\new bottom LOW BPS.mp4"
OUT = r"C:\Users\mnede\Documents\Claude\social-media\schedule-tweets\longform\new-bottom\new-bottom.mp4"
