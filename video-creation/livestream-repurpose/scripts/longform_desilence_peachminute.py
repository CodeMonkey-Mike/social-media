"""Fast single-pass silence removal for the 'peach-minute' longform.
silencedetect -> keep intervals -> ONE ffmpeg NVENC pass via the concat demuxer, dropping the
gaps. Outputs ~0.7 Mbps directly to the staged location. Modeled on longform_desilence_newbottom.py.
"""
import subprocess, re, os, sys

SRC = r"C:\Users\mnede\Documents\Claude\social-media\video-creation\livestream-repurpose\media\peach-minute\peach-minute LOW BPS.mp4"
OUT = r"C:\Users\mnede\Documents\Claude\social-media\schedule-tweets\longform\peach-minute\peach-minute.mp4"
