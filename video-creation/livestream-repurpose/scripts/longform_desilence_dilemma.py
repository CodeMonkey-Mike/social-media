"""Per-batch longform desilence for the '4-year cycle dilemma' stream.
Modeled on longform_desilence_fast.py: silencedetect -> keep intervals ->
ONE NVENC concat pass dropping the gaps, output ~0.7 Mbps directly to the staged longform location.
"""
import subprocess, re, os, sys

SRC = r"C:\Users\mnede\Documents\Claude\social-media\video-creation\livestream-repurpose\media\4-year cycle dilemma\4-year cycle dilemma LOW BPS.mp4"
OUT = r"C:\Users\mnede\Documents\Claude\social-media\schedule-tweets\longform\4-year-cycle-dilemma\4-year-cycle-dilemma.mp4"
