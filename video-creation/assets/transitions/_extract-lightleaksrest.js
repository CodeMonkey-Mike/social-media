#!/usr/bin/env node
/** Per-clip real data for LIGHT LEAKS / Light Leaks (8 sequences). Same walker +
 * AEMask decode as _extract-glassbeveled.js. Plates expected (Hst - Flr Light
 * Leaks + Blur Map videos) — mediaPath captured per MasterClip. */
const fs = require('fs');
...
const BASES = [
 ...
 "Light Leaks Soft - 8",
 "Light Leaks Soft - 9",
 "Light Leaks Soft Short - 1",
 "Light Leaks Soft Short - 2",
 "Light Leaks Soft Short - 3",
 "Light Leaks Soft Short - 4",
 "Light Leaks Soft Short - 5",
 "Light Leaks Soft Short - 6",
 "Light Leaks Soft Short - 7",
 "Light Leaks Soft Short - 8",
 "Light Leaks Soft Short - 9"
];
...
const outfile = filter ? '_lightleaks-sample.json' : '_lightleaksrest-clips.json';
