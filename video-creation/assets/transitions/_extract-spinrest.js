#!/usr/bin/env node
/** Per-clip real data for the remaining SPIN subgroups (Center/Corner Ease + Swinging, Corner Bounce, Shake 1x/2x, Twirl, each + Short = 44 A->B transitions). Full capture. */
const fs = require('fs');
...
const BASES = [
 "Spin Center Ease - CCW",
 "Spin Center Ease - CW",
 "Spin Center Ease Short - CCW",
 "Spin Center Ease Short - CW",
 "Spin Center Swinging - CCW",
 "Spin Center Swinging - CW",
 "Spin Center Swinging Short - CCW",
 "Spin Center Swinging Short - CW",
 "Spin Corner Bounce - LB",
 "Spin Corner Bounce - LT",
 "Spin Corner Bounce - RB",
 "Spin Corner Bounce - RT",
 "Spin Corner Bounce Short - LB",
 "Spin Corner Bounce Short - LT",
 "Spin Corner Bounce Short - RB",
 "Spin Corner Bounce Short - RT",
 "Spin Corner Ease - LB",
 "Spin Corner Ease - LT",
 "Spin Corner Ease - RB",
 "Spin Corner Ease - RT",
 "Spin Corner Ease Short - LB",
 "Spin Corner Ease Short - LT",
 "Spin Corner Ease Short - RB",
 "Spin Corner Ease Short - RT",
 "Spin Corner Swinging - LB",
 "Spin Corner Swinging - LT",
 "Spin Corner Swinging - RB",
 "Spin Corner Swinging - RT",
 "Spin Corner Swinging Short - LB",
 "Spin Corner Swinging Short - LT",
 "Spin Corner Swinging Short - RB",
 "Spin Corner Swinging Short - RT",
 "Spin Shake 1x - CCW",
 "Spin Shake 1x - CW",
 "Spin Shake 2x - CCW",
 "Spin Shake 2x - CW",
 "Spin Shake Short 1x - CCW",
 "Spin Shake Short 1x - CW",
 "Spin Shake Short 2x - CCW",
 "Spin Shake Short 2x - CW",
 "Spin Twirl - CCW",
 "Spin Twirl - CW",
 "Spin Twirl Short - CCW",
 "Spin Twirl Short - CW"
];
...
const outfile = filter ? '_spinrest-sample.json' : '_spinrest-clips.json';
