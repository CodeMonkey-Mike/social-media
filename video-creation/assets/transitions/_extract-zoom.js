#!/usr/bin/env node
/** Per-clip real data for the ZOOM category (70 sequences, 16 subgroups: Ease/Hit/Optics/Optics Spin/Shake 1-2x/Simple/Spin/Swinging + Short twins). Full capture. */
const fs = require('fs');
...
const BASES = [
 ...
 "Zoom Ease - Out",
 "Zoom Ease Short - In",
 "Zoom Ease Short - In Out",
 "Zoom Ease Short - Out",
 "Zoom Hit - In",
 "Zoom Hit - In Out",
 "Zoom Hit - Out",
 "Zoom Hit Short - In",
 "Zoom Hit Short - In Out",
 "Zoom Hit Short - Out",
 "Zoom Optics - In",
 "Zoom Optics - In Impact",
 "Zoom Optics - In Out 1",
 "Zoom Optics - In Out 2",
 "Zoom Optics - In Out 3",
 "Zoom Optics - Out",
 "Zoom Optics Short - In",
 "Zoom Optics Short - In Impact",
 "Zoom Optics Short - In Out 1",
 "Zoom Optics Short - In Out 2",
 "Zoom Optics Short - In Out 3",
 "Zoom Optics Short - Out",
 "Zoom Optics Spin - In CCW",
 "Zoom Optics Spin - In CW",
 "Zoom Optics Spin - In Out CCW",
 "Zoom Optics Spin - In Out CW",
 "Zoom Optics Spin - Out CCW",
 "Zoom Optics Spin - Out CW",
 "Zoom Optics Spin Short - In CCW",
 "Zoom Optics Spin Short - In CW",
 "Zoom Optics Spin Short - In Out CCW",
 "Zoom Optics Spin Short - In Out CW",
 "Zoom Optics Spin Short - Out CCW",
 "Zoom Optics Spin Short - Out CW",
 "Zoom Shake 1x - In",
 "Zoom Shake 1x - In Out",
 "Zoom Shake 1x - Out",
 "Zoom Shake 2x - In",
 "Zoom Shake 2x - In Out",
 "Zoom Shake 2x - Out",
 "Zoom Shake Short 1x - In",
 "Zoom Shake Short 1x - In Out",
 "Zoom Shake Short 1x - Out",
 "Zoom Shake Short 2x - In",
 "Zoom Shake Short 2x - In Out",
 "Zoom Shake Short 2x - Out",
 "Zoom Simple - In",
 "Zoom Simple - In Out",
 "Zoom Simple - Out",
 "Zoom Simple Short - In",
 "Zoom Simple Short - In Out",
 "Zoom Simple Short - Out",
 "Zoom Spin - In CCW",
 "Zoom Spin - In CW",
 "Zoom Spin - In Out CCW",
 "Zoom Spin - In Out CW",
 "Zoom Spin - Out CCW",
 "Zoom Spin - Out CW",
 "Zoom Spin Short - In CCW",
 "Zoom Spin Short - In CW",
 "Zoom Spin Short - In Out CCW",
 "Zoom Spin Short - In Out CW",
 "Zoom Spin Short - Out CCW",
 "Zoom Spin Short - Out CW",
 "Zoom Swinging - In",
 "Zoom Swinging - Out",
 "Zoom Swinging Short - In",
 "Zoom Swinging Short - Out"
];
...
const outfile = filter ? '_zoom-sample.json' : '_zoom-clips.json';
