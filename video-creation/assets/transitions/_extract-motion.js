#!/usr/bin/env node
/** Per-clip real data for the MOTION category (55 single-scene accent moves: 3D Offset 16, 3D Orbit 16, 3D Pan 8, Shake 3D 5, Shake Optics 6, Shake Simple 4). Full capture incl. masks, in/out points, remaps. */
const fs = require('fs');
...
const BASES = [
 "Motion 3D Offset 1 - Left Down",
 "Motion 3D Offset 1 - Left Up",
 "Motion 3D Offset 1 - Right Down",
 "Motion 3D Offset 1 - Right Up",
 "Motion 3D Offset 2 - Left Down",
 "Motion 3D Offset 2 - Left Up",
 "Motion 3D Offset 2 - Right Down",
 "Motion 3D Offset 2 - Right Up",
 "Motion 3D Offset 3 - Left Down",
 "Motion 3D Offset 3 - Left Up",
 "Motion 3D Offset 3 - Right Down",
 "Motion 3D Offset 3 - Right Up",
 "Motion 3D Offset 4 - Left Down",
 "Motion 3D Offset 4 - Left Up",
 "Motion 3D Offset 4 - Right Down",
 "Motion 3D Offset 4 - Right Up",
 "Motion 3D Orbit 1 - B Left",
 "Motion 3D Orbit 1 - B Right",
 "Motion 3D Orbit 1 - T Left",
 "Motion 3D Orbit 1 - T Right",
 "Motion 3D Orbit 2 - Left Down",
 "Motion 3D Orbit 2 - Left Up",
 "Motion 3D Orbit 2 - Right Down",
 "Motion 3D Orbit 2 - Right Up",
 "Motion 3D Orbit 3 - B CCW",
 "Motion 3D Orbit 3 - B CW",
 "Motion 3D Orbit 3 - T CCW",
 "Motion 3D Orbit 3 - T CW",
 "Motion 3D Orbit 4 - B CCW",
 "Motion 3D Orbit 4 - B CW",
 "Motion 3D Orbit 4 - T CCW",
 "Motion 3D Orbit 4 - T CW",
 "Motion 3D Pan 1 - Down",
 "Motion 3D Pan 1 - Left",
 "Motion 3D Pan 1 - Right",
 "Motion 3D Pan 1 - Up",
 "Motion 3D Pan 2 - Down",
 "Motion 3D Pan 2 - Left",
 "Motion 3D Pan 2 - Right",
 "Motion 3D Pan 2 - Up",
 "Motion Shake 3D - 1x",
 "Motion Shake 3D - 2x",
 "Motion Shake 3D - 3x",
 "Motion Shake 3D - 4x",
 "Motion Shake 3D - 5x",
 "Motion Shake Optics - 1x",
 "Motion Shake Optics - 2x",
 "Motion Shake Optics - 3x",
 "Motion Shake Optics - 4x",
 "Motion Shake Optics - 5x",
 "Motion Shake Optics - 6x",
 "Motion Shake Simple - 1x",
 "Motion Shake Simple - 2x",
 "Motion Shake Simple - 3x",
 "Motion Shake Simple - 4x"
];
...
const outfile = filter ? '_motion-sample.json' : '_motion-clips.json';
