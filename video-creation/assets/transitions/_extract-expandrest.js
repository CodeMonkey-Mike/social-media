 ...
 * param (static value + ALL keyframes). Writes _expandrest-clips.json.
...
const NAMES = [];
for (const f of ["Expand In","Expand In Short","Expand Out","Expand Out Short","Expand Out In","Expand Out In Short"]) for (const d of ["Horizontal","Vertical"]) NAMES.push(f+" - "+d);
...
const outfile = filter ? '_expandrest-clips.json' : '_expandrest-clips.json';
