 ...
 * Writes _roughly-clips.json. Reads decompressed project XML from %TEMP%/sw.xml
...
fs.writeFileSync(path.join(__dirname, '_roughly-clips.json'), JSON.stringify(out, null, 2));
process.stdout.write('DONE -> _roughly-clips.json\n');
