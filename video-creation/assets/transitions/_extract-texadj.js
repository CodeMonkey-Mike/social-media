 ...
 * Writes _texadj-clips.json. Reads decompressed project XML from %TEMP%/sw.xml
...
const NAMES = ['Texture Adjustment'];
...
fs.writeFileSync(path.join(__dirname, '_texadj-clips.json'), JSON.stringify(out, null, 2));
process.stdout.write('DONE -> _texadj-clips.json\n');
