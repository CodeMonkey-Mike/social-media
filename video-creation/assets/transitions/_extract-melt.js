#!/usr/bin/env node
/** Per-clip real data for the MELT category (30 sequences: Equidistant 4+4, RGB 7+7, RGB Soft 4+4). Full capture: effects+kfs+handles, AEMasks, media (deep), in/out points, time remaps. */
const fs = require('fs');
...
const BASES = [
 ...
 "Melt Equidistant - 3",
 "Melt Equidistant - 4",
 "Melt Equidistant Short - 1",
 "Melt Equidistant Short - 2",
 "Melt Equidistant Short - 3",
 "Melt Equidistant Short - 4",
 "Melt RGB - 1",
 "Melt RGB - 2",
 "Melt RGB - 3",
 "Melt RGB - 4",
 ...
 "Melt RGB Short - 6",
 "Melt RGB Short - 7",
 "Melt RGB Soft Short - 1",
 "Melt RGB Soft Short - 2",
 "Melt RGB Soft Short - 3",
 "Melt RGB Soft Short - 4"
];
...
const outfile = filter ? '_melt-sample.json' : '_melt-clips.json';
