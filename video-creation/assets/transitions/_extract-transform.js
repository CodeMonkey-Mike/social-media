#!/usr/bin/env node
/** Per-clip real data for the TRANSFORM category (40 sequences, 8 subgroups: 1/2/3/4 + Short twins). Full capture. */
const fs = require('fs');
...
const BASES = [
 "Transform 1 - Down Left",
 "Transform 1 - Down Right",
 "Transform 1 - Up Left",
 "Transform 1 - Up Right",
 "Transform 2 - Down",
 "Transform 2 - Left",
 "Transform 2 - Left Down",
 "Transform 2 - Left Up",
 "Transform 2 - Right",
 "Transform 2 - Right Down",
 "Transform 2 - Right Up",
 "Transform 2 - Up",
 "Transform 3 - Left Down",
 "Transform 3 - Left Up",
 "Transform 3 - Right Down",
 "Transform 3 - Right Up",
 "Transform 4 - Left Down",
 "Transform 4 - Left Up",
 "Transform 4 - Right Down",
 "Transform 4 - Right Up",
 "Transform Short 1 - Down Left",
 "Transform Short 1 - Down Right",
 "Transform Short 1 - Up Left",
 "Transform Short 1 - Up Right",
 "Transform Short 2 - Down",
 "Transform Short 2 - Left",
 "Transform Short 2 - Left Down",
 "Transform Short 2 - Left Up",
 "Transform Short 2 - Right",
 "Transform Short 2 - Right Down",
 "Transform Short 2 - Right Up",
 "Transform Short 2 - Up",
 "Transform Short 3 - Left Down",
 "Transform Short 3 - Left Up",
 "Transform Short 3 - Right Down",
 "Transform Short 3 - Right Up",
 "Transform Short 4 - Left Down",
 "Transform Short 4 - Left Up",
 "Transform Short 4 - Right Down",
 "Transform Short 4 - Right Up"
];
...
const outfile = filter ? '_transform-sample.json' : '_transform-clips.json';
