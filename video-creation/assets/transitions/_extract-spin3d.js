#!/usr/bin/env node
/** Per-clip real data for SPIN 3D (Center/Corner Ease B|T CW|CCW + Side Ease 4 dirs, + Shorts = 24 A->B transitions). Full capture. */
const fs = require('fs');
...
const BASES = [
 "Spin 3D Center Ease - B CCW",
 "Spin 3D Center Ease - B CW",
 "Spin 3D Center Ease - T CCW",
 "Spin 3D Center Ease - T CW",
 "Spin 3D Center Ease Short - B CCW",
 "Spin 3D Center Ease Short - B CW",
 "Spin 3D Center Ease Short - T CCW",
 "Spin 3D Center Ease Short - T CW",
 "Spin 3D Corner Ease - B CCW",
 "Spin 3D Corner Ease - B CW",
 "Spin 3D Corner Ease - T CCW",
 "Spin 3D Corner Ease - T CW",
 "Spin 3D Corner Ease Short - B CCW",
 "Spin 3D Corner Ease Short - B CW",
 "Spin 3D Corner Ease Short - T CCW",
 "Spin 3D Corner Ease Short - T CW",
 "Spin 3D Side Ease - Down",
 "Spin 3D Side Ease - Left",
 "Spin 3D Side Ease - Right",
 "Spin 3D Side Ease - Up",
 "Spin 3D Side Ease Short - Down",
 "Spin 3D Side Ease Short - Left",
 "Spin 3D Side Ease Short - Right",
 "Spin 3D Side Ease Short - Up"
];
...
const outfile = filter ? '_spin3d-sample.json' : '_spin3d-clips.json';
