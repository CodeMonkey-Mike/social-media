 ...
 * param (static value + ALL keyframes). Writes _deviation4k-clips.json.
...
const NAMES = [];
for (const f of ["Deviation Optics","Deviation Shift"]) for (const n of [1,2,3,4]) NAMES.push(f+" - "+n+"x");
...
const outfile = filter ? '_deviation4k-clips.json' : '_deviation4k-clips.json';
