#!/usr/bin/env node
/** Per-clip real data for the REMAINING GLASS sub-families (28 sequences):
 * Beveled Short 12 + Blocks 4 + Blocks Corner 12. Same walker + AEMask decode as
 * _extract-glassbeveled.js (see that file for the architecture notes). */
const fs = require('fs');
...
const BASES = [
  "Glass Beveled Short 1 - Up",
  "Glass Beveled Short 1 - Down",
  "Glass Beveled Short 1 - Left",
  "Glass Beveled Short 1 - Right",
  "Glass Beveled Short 2 - Up",
  "Glass Beveled Short 2 - Down",
  "Glass Beveled Short 2 - Left",
  "Glass Beveled Short 2 - Right",
  "Glass Beveled Short 3 - Horizontal",
  "Glass Beveled Short 3 - Vertical",
  "Glass Beveled Short 4 - Horizontal",
  "Glass Beveled Short 4 - Vertical",
  "Glass Blocks 1 - Left",
  "Glass Blocks 1 - Right",
  "Glass Blocks 2 - Horizontal",
  "Glass Blocks 3 - Horizontal",
  "Glass Blocks Corner 1 - Left Up",
  "Glass Blocks Corner 1 - Left Down",
  "Glass Blocks Corner 1 - Right Up",
  "Glass Blocks Corner 1 - Right Down",
  "Glass Blocks Corner 2 - Left Up",
  "Glass Blocks Corner 2 - Left Down",
  "Glass Blocks Corner 2 - Right Up",
  "Glass Blocks Corner 2 - Right Down",
  "Glass Blocks Corner 3 - Left Up",
  "Glass Blocks Corner 3 - Left Down",
  "Glass Blocks Corner 3 - Right Up",
  "Glass Blocks Corner 3 - Right Down"
];
...
const outfile = filter ? '_glassrest-sample.json' : '_glassrest-clips.json';
