...
const BASES = ["Pre Light Leaks 1","Pre Light Leaks 2","Pre Light Leaks 3","Pre Light Leaks 4","Pre Light Leaks 5","Pre Light Leaks 6","Pre Light Leaks 7","Pre Light Leaks 8"];
...
const outfile = filter ? '_lightleaks-sample.json' : '_lightleaks-nested-clips.json';
