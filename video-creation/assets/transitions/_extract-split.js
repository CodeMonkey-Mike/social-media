#!/usr/bin/env node
/** Per-clip real data for the SPLIT category (144 sequences, 14 subgroups) + the Split Percent utility sequence. Full capture. */
const fs = require('fs');
...
const BASES = [
 "Split Ease - Diagonal - 1",
 "Split Ease - Diagonal - 2",
 "Split Ease - Diagonal - 3",
 "Split Ease - Diagonal - 4",
 "Split Ease - Diagonal Combs - 1",
 "Split Ease - Diagonal Combs - 2",
 "Split Ease - Diagonal Combs - 3",
 "Split Ease - Diagonal Combs - 4",
 "Split Ease HV - 1",
 "Split Ease HV - 2",
 "Split Ease Horizontal - 1",
 "Split Ease Horizontal - 2",
 "Split Ease Short - Diagonal - 1",
 "Split Ease Short - Diagonal - 2",
 "Split Ease Short - Diagonal - 3",
 "Split Ease Short - Diagonal - 4",
 "Split Ease Short - Diagonal Combs - 1",
 "Split Ease Short - Diagonal Combs - 2",
 "Split Ease Short - Diagonal Combs - 3",
 "Split Ease Short - Diagonal Combs - 4",
 "Split Ease Short HV - 1",
 "Split Ease Short HV - 2",
 "Split Ease Short Horizontal - 1",
 "Split Ease Short Horizontal - 2",
 "Split Ease Short VH - 1",
 "Split Ease Short VH - 2",
 "Split Ease Short Vertical - 1",
 "Split Ease Short Vertical - 2",
 "Split Ease VH - 1",
 "Split Ease VH - 2",
 "Split Ease Vertical - 1",
 "Split Ease Vertical - 2",
 "Split Easy Offset Combs - 1",
 "Split Easy Offset Combs - 2",
 "Split Easy Offset Combs - 3",
 "Split Easy Offset Combs - 4",
 "Split Easy Offset Layout 1x2 - 1",
 "Split Easy Offset Layout 1x2 - 2",
 "Split Easy Offset Layout 2x1 - 1",
 "Split Easy Offset Layout 2x1 - 2",
 "Split Easy Offset Short Combs - 1",
 "Split Easy Offset Short Combs - 2",
 "Split Easy Offset Short Combs - 3",
 "Split Easy Offset Short Combs - 4",
 "Split Easy Offset Short Layout 1x2 - 1",
 "Split Easy Offset Short Layout 1x2 - 2",
 "Split Easy Offset Short Layout 2x1 - 1",
 "Split Easy Offset Short Layout 2x1 - 2",
 "Split Percent",
 "Split Perspective Horizontal - 1",
 "Split Perspective Horizontal - 2",
 "Split Perspective Short Horizontal - 1",
 "Split Perspective Short Horizontal - 2",
 "Split Perspective Short Vertical - 1",
 "Split Perspective Short Vertical - 2",
 "Split Perspective Vertical - 1",
 "Split Perspective Vertical - 2",
 "Split Slide 1 - Down",
 "Split Slide 1 - Left",
 "Split Slide 1 - Right",
 "Split Slide 1 - Up",
 ...
 "Split Slide 3 - Right",
 "Split Slide 3 - Up",
 "Split Slide Cross 1 - Down",
 "Split Slide Cross 1 - Left",
 "Split Slide Cross 1 - Right",
 "Split Slide Cross 1 - Up",
 "Split Slide Cross 2 - Down",
 "Split Slide Cross 2 - Left",
 "Split Slide Cross 2 - Right",
 "Split Slide Cross 2 - Up",
 "Split Slide Cross Short 1 - Down",
 "Split Slide Cross Short 1 - Left",
 "Split Slide Cross Short 1 - Right",
 "Split Slide Cross Short 1 - Up",
 "Split Slide Cross Short 2 - Down",
 "Split Slide Cross Short 2 - Left",
 "Split Slide Cross Short 2 - Right",
 "Split Slide Cross Short 2 - Up",
 "Split Slide Short 1 - Down",
 "Split Slide Short 1 - Left",
 "Split Slide Short 1 - Right",
 "Split Slide Short 1 - Up",
 "Split Slide Short 2 - Down",
 "Split Slide Short 2 - Left",
 "Split Slide Short 2 - Right",
 "Split Slide Short 2 - Up",
 "Split Slide Short 3 - Down",
 "Split Slide Short 3 - Left",
 "Split Slide Short 3 - Right",
 "Split Slide Short 3 - Up",
 "Split Swinging - Diagonal - 1",
 "Split Swinging - Diagonal - 2",
 "Split Swinging - Diagonal - 3",
 "Split Swinging - Diagonal - 4",
 "Split Swinging - Diagonal Combs - 1",
 "Split Swinging - Diagonal Combs - 2",
 "Split Swinging - Diagonal Combs - 3",
 "Split Swinging - Diagonal Combs - 4",
 "Split Swinging HV - 1",
 "Split Swinging HV - 2",
 "Split Swinging Horizontal - 1",
 "Split Swinging Horizontal - 2",
 "Split Swinging Offset Combs - 1",
 "Split Swinging Offset Combs - 2",
 "Split Swinging Offset Combs - 3",
 "Split Swinging Offset Combs - 4",
 "Split Swinging Offset Layout 1x2 - 1",
 "Split Swinging Offset Layout 1x2 - 2",
 "Split Swinging Offset Layout 2x1 - 1",
 "Split Swinging Offset Layout 2x1 - 2",
 "Split Swinging Offset Short Combs - 1",
 "Split Swinging Offset Short Combs - 2",
 "Split Swinging Offset Short Combs - 3",
 "Split Swinging Offset Short Combs - 4",
 "Split Swinging Offset Short Layout 1x2 - 1",
 "Split Swinging Offset Short Layout 1x2 - 2",
 "Split Swinging Offset Short Layout 2x1 - 1",
 "Split Swinging Offset Short Layout 2x1 - 2",
 "Split Swinging Short - Diagonal - 1",
 "Split Swinging Short - Diagonal - 2",
 "Split Swinging Short - Diagonal - 3",
 "Split Swinging Short - Diagonal - 4",
 "Split Swinging Short - Diagonal Combs - 1",
 "Split Swinging Short - Diagonal Combs - 2",
 "Split Swinging Short - Diagonal Combs - 3",
 "Split Swinging Short - Diagonal Combs - 4",
 "Split Swinging Short HV - 1",
 "Split Swinging Short HV - 2",
 "Split Swinging Short Horizontal - 1",
 "Split Swinging Short Horizontal - 2",
 "Split Swinging Short VH - 1",
 "Split Swinging Short VH - 2",
 "Split Swinging Short Vertical - 1",
 "Split Swinging Short Vertical - 2",
 "Split Swinging VH - 1",
 "Split Swinging VH - 2",
 "Split Swinging Vertical - 1",
 "Split Swinging Vertical - 2"
];
...
const outfile = filter ? '_split-sample.json' : '_split-clips.json';
